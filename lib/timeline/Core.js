...
Core.prototype._create = function (container) {
  ...
  function onMouseWheel(event) {
    ...
    if ( 'detail'      in event ) { deltaY = event.detail * -1 * 32;      }
  ...
  function onMouseScrollSide(event) {
    ...
    if (me.isActive()) {
      ...
      //console.log(event.target.scrollTop, event.originalTarget.scrollTop);
    ...
    this.dom.left.parentNode.addEventListener('DOMMouseScroll', onMouseWheel.bind(this), false);
